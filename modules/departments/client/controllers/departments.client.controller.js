(function () {
  ...
  DepartmentsController.$inject = ['$scope', '$state', 'Authentication', 'departmentResolve', 'EmployeesService'];

  function DepartmentsController ($scope, $state, Authentication, department, EmployeesService, $resource) {
    var vm = this;
